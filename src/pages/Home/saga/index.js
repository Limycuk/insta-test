...
import getDataByFilters from '~/packages/rest/services/getDataByFilters';
import * as filterelectors from '~/selectors/filters';
...
function* loadData() {
  const filters = yield select(filterelectors.getFilters);
